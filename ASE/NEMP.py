...
class NEMP(Calculator):
    ...
    def __init__(self, skin=1.0, pbc=[0, 0, 0], skin_neigh=20, getneigh=None, fconfig='full_config.json', initatoms=None, field=(0.0, 0.0, 0.0), properties=['energy', 'forces'], **kwargs):
        ...
        if 'forces' in properties and 'dipole' in properties and 'stress' not in properties:
            def get_e_f_d(params, coor, field, cell, disp_cell, neighlist, shiftimage, center_factor, species):
        ...
        elif 'dipole' in properties:
            def get_e_d(params, coor, field, cell, disp_cell, neighlist, shiftimage, center_factor, species):
