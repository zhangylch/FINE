...
class JsonConfig:
    ...
    dipole_sign: int = field(default=1)
    bec_sign: int = field(default=-1)
    ...
    init_weight: List[float] = field(default_factory = lambda: [1.0, 1.0, 1.0, 1.0])
    final_weight: List[float] = field(default_factory = lambda: [1.0, 1.0, 1.0, 1.0])
